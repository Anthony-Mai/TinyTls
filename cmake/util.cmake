...
# Creates dummy source file in $GEN_SRC_DIR named $basename.$extension and
...
macro(create_dummy_source_file basename extension out_file_list_var)
  set(dummy_source_file "${GEN_SRC_DIR}/${basename}_dummy.${extension}")
  file(
    WRITE
...
#
# The names of variables defaulted through this macro are added to $CONFIG_VARS
# to facilitate build logging and diagnostics.
macro(detect_var name value type helpstring)
  unset(list_index)
  list(FIND DETECT_VARS ${name} list_index)
  if(${list_index} EQUAL -1)
    list(APPEND DETECT_VARS ${name})
  endif()
...
# The names of variables defaulted through this macro are added to $CONFIG_VARS
# to facilitate build logging and diagnostics.
macro(config_var name value type helpstring)
  unset(list_index)
  list(FIND CONFIG_VARS ${name} list_index)
  if(${list_index} EQUAL -1)
    list(APPEND CONFIG_VARS ${name})
  endif()
...
# $OPTION_VARS to facilitate build logging and diagnostics.
macro(option_var name helpstring value)
  unset(list_index)
  list(FIND OPTION_VARS ${name} list_index)
  if(${list_index} EQUAL -1)
    list(APPEND OPTION_VARS ${name})
  endif()
